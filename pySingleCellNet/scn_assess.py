...
def assess_comm(aTrain, aQuery, resolution = 0.005, nRand = 50, dLevelSID = "sample_name", classTrain = "cell_ontology_class", classQuery = "description2"):
    ...
    confusionMatrix = pySCN.cn_classAssess(ct_score_com, stVal_com, classLevels= classQuery, dLevelSID=dLevelSID, resolution=resolution)
    ...
    nonNA_PR = dropna(subset=['recall'], axis="rows").copy()
